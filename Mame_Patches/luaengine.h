...
// Forward declaration of mame_machine_manager
...
public:
    ...
    // Update constructor to accept the owning mame_machine_manager pointer.
    // This allows the lua_engine instance to back-reference its owner.
    lua_engine(mame_machine_manager *manager);
	~lua_engine();
...
private:
	...
	// internal state
	mame_machine_manager *m_mame_manager;
